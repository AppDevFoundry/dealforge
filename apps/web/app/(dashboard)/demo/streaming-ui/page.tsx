      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
            <li>Show a market snapshot for Bexar County with FMR of $1,200 and unemployment 4.5%</li>
            ...
            <li>Create a park card for "Oak Grove MHP" in Dallas County with 45 lots and distress score 72</li>
