...
type FormatType = 'currency' | 'percentage' | 'number' | 'ratio' | 'multiple';

interface SyndicationResultsCardProps {
  label: string;
  value: number;
  format: FormatType;
  explanation?: string;
...
export function SyndicationResultsCard({
  label,
  value,
  format,
  explanation,
